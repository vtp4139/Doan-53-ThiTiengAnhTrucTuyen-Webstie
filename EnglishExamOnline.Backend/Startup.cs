...
namespace EnglishExamOnline.Backend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "English Exam API", Version = "v1" });
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        AuthorizationCode = new OpenApiOAuthFlow
                        {
                            ...
                            Scopes = new Dictionary<string, string> { { "english_exam.api", "English Exam API" } }
                        },
                    },
                });
                ...
                {
                    {
                        ...
                        new List<string>{ "english_exam.api" }
                    }
                });
            });
