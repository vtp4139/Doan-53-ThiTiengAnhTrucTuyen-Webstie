...
namespace EnglishExamOnline.Backend.Data.Migrations
{
    ...
    [Migration("20210416042907_SeedDb02")]
    partial class SeedDb02
    {
            ...
            modelBuilder.Entity("EnglishExamOnline.Backend.Models.Contest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 344, DateTimeKind.Local).AddTicks(8236),
                        ...
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1094),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1123),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1126),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1128),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 3,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1131),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1133),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1135),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1137),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1139),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 16, 11, 29, 6, 346, DateTimeKind.Local).AddTicks(1141),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        });
                });
