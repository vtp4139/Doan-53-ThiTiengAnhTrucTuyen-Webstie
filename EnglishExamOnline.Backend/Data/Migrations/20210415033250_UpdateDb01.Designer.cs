...
namespace EnglishExamOnline.Backend.Data.Migrations
{
    ...
    [Migration("20210415033250_UpdateDb01")]
            ...
            modelBuilder.Entity("EnglishExamOnline.Backend.Models.Contest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 90, DateTimeKind.Local).AddTicks(3094),
                        ...
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3827),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3917),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3923),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3926),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 3,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3929),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3936),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3939),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3942),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3945),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 4, 15, 10, 32, 49, 92, DateTimeKind.Local).AddTicks(3948),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        });
                });
