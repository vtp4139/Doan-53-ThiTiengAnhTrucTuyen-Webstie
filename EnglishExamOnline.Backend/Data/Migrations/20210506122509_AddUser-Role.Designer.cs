...
namespace EnglishExamOnline.Backend.Data.Migrations
{
    ...
    [Migration("20210506122509_AddUser-Role")]
            ...
            modelBuilder.Entity("EnglishExamOnline.Backend.Models.Contest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 133, DateTimeKind.Local).AddTicks(9342),
                        ...
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6779),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6812),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6909),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestScheduleId = 2,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6914),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 3,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6917),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = true
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Morning) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6920),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6923),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6926),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Night) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6929),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        },
                        new
                        {
                            ...
                            ContestName = "English Test (Afternoon) - ETS 21",
                            ContestScheduleId = 1,
                            CreatedDate = new DateTime(2021, 5, 6, 19, 25, 8, 135, DateTimeKind.Local).AddTicks(6931),
                            Description = "The ETS is an international standardized test of English language proficiency for non-native speakers. It is intentionally designed to measure the everyday English skills of people working in an international environment.",
                            Status = false
                        });
                });
            ...
            modelBuilder.Entity("EnglishExamOnline.Backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2243634607",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "487be84b-f0bf-4a69-8318-e5e1672d83a9",
                            Email = "admin@vp.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@VP.COM",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAEAACcQAAAAEPYQl//PFcgB7+wdLOyGbTKDde0AGVkbGQFsKoPn5Gqyrf3GJUXYPnFCuXR4EvFMtQ==",
                        ...
                        new
                        {
                            Id = "4695426118",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e086727a-e9b5-4a32-bb2e-9bf3c796b785",
                            Email = "user@vp.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER@VP.COM",
                            NormalizedUserName = "user",
                            PasswordHash = "AQAAAAEAACcQAAAAEGxnnuBnOU1/zOlmtsM8VXmFgRqrQi4rcdDA7Iw1EOMKv7v639gkWZ+JF6uQdmqzig==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "user"
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "7200984639",
                            ConcurrencyStamp = "5cf8e42f-0806-4fee-a685-7215fc46802c",
                            Name = "Admin",
                        ...
                        {
                            Id = "4835914310",
                            ConcurrencyStamp = "3bf63b38-3d9b-47ec-8cb5-eefea7759b98",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
